...
down_revision: Union[str, None] = '8cbcf838420b'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_complaint_ai_analysis_complaint_id'), 'complaint_ai_analysis', ['complaint_id'], unique=True)
    op.create_index(op.f('ix_complaint_ai_analysis_id'), 'complaint_ai_analysis', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_complaint_priority_scores_complaint_id'), 'complaint_priority_scores', ['complaint_id'], unique=True)
    op.create_index(op.f('ix_complaint_priority_scores_id'), 'complaint_priority_scores', ['id'], unique=False)


def downgrade() -> None:
    op.drop_index(op.f('ix_complaint_priority_scores_id'), table_name='complaint_priority_scores')
    op.drop_index(op.f('ix_complaint_priority_scores_complaint_id'), table_name='complaint_priority_scores')
    op.drop_table('complaint_priority_scores')

    op.drop_index(op.f('ix_complaint_ai_analysis_id'), table_name='complaint_ai_analysis')
    op.drop_index(op.f('ix_complaint_ai_analysis_complaint_id'), table_name='complaint_ai_analysis')
